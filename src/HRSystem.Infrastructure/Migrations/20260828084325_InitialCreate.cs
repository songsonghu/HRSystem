        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsibleDeptId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountTypes_Departments_ResponsibleDeptId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountValue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    OpenedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DisabledAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SourceRequestItemId = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountTypeId = table.Column<int>(type: "int", nullable: false),
                    AssignedDeptId = table.Column<int>(type: "int", nullable: false),
                    AssignedUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    AccountValue = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ResultRemark = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountRequestItems", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccountRequestItems_Departments_AssignedDeptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountRequestItems_AssignedDeptId",
                table: "AccountRequestItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountRequests_RequestNo",
                table: "AccountRequests",
                column: "RequestNo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountTypes_ResponsibleDeptId",
                table: "AccountTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAccounts_EmployeeId_AccountTypeId",
                table: "EmployeeAccounts",
                columns: new[] { "EmployeeId", "AccountTypeId" });
